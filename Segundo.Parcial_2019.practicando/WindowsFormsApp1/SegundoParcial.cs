...
namespace SP
{
    ...
    {
        private Manzana _manzana = new Manzana ("Azul",10,"La Pampa");
        private Banana _banana = new Banana("Verde", 3, "Brasil");
        private Durazno _durazno = new Durazno("Naranja", 4,83);
        ...
        {
            MessageBox.Show("Rodriguez Emiliano");
        }
        ...
        {
            SqlConnection conexion = new SqlConnection("Data Source = DESKTOP-60L3OD9 ; Initial Catalog = sp_lab_II ; Integrated Security = True ");
            SqlCommand comando = new SqlCommand();
            string query = "SELECT nombre , precio , peso FROM frutas ";
            Fruta auxFruta;
            string retorno = "";
